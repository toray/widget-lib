...
static jobject createGifInfoHandle(GifInfo *gifInfo, JNIEnv *env) {
    ...
    jclass gifInfoHandleClass = (*env)->FindClass(env,
            "com/toraysoft/widget/gif/GifInfoHandle");
...
static void throwGifIOException(int errorCode, JNIEnv *env) {//nullchecks just to prevent segfaults, LinkageError will be thrown if GifIOException cannot be instantiated
    jclass exClass = (*env)->FindClass(env,
            "com/toraysoft/widget/gif/GifIOException");
    if (exClass == NULL)
        return;
...
Java_com_toraysoft_widget_gif_GifInfoHandle_openFile(JNIEnv *env, jclass __unused class,
...
JNIEXPORT jobject JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_openByteArray(JNIEnv *env, jclass __unused class,
...
JNIEXPORT jobject JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_openDirectByteBuffer(JNIEnv *env,
...
JNIEXPORT jobject JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_openStream(JNIEnv *env, jclass __unused class,
...
JNIEXPORT jobject JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_openFd(JNIEnv *env, jclass __unused handleClass,
...
Java_com_toraysoft_widget_gif_GifInfoHandle_reset(JNIEnv *__unused  env, jclass  __unused class,
        jlong gifInfo) {
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_setSpeedFactor(JNIEnv __unused *env, jclass __unused handleClass,
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_seekToTime(JNIEnv *env, jclass __unused handleClass,
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_seekToFrame(JNIEnv *env, jclass __unused handleClass,
...
Java_com_toraysoft_widget_gif_GifInfoHandle_renderFrame(JNIEnv *env, jclass __unused handleClass,
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_free(JNIEnv *env, jclass __unused handleClass,
        jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return;
...
Java_com_toraysoft_widget_gif_GifInfoHandle_getComment(JNIEnv *env, jclass __unused handleClass,
        jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return NULL;
...
Java_com_toraysoft_widget_gif_GifInfoHandle_getLoopCount(JNIEnv __unused *env, jclass __unused handleClass,
        jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return 0;
...
JNIEXPORT jint JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_getDuration(JNIEnv *__unused  env, jclass __unused handleClass,
        jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return 0;
...
JNIEXPORT jint JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_getCurrentPosition(JNIEnv *__unused env,
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_saveRemainder(JNIEnv *__unused  env, jclass __unused handleClass,
        jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return;
...
JNIEXPORT void JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_restoreRemainder(JNIEnv *__unused env,
        jclass __unused handleClass, jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
...
JNIEXPORT jlong JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_getAllocationByteCount(JNIEnv *__unused  env,
        jclass __unused handleClass, jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return 0;
...
JNIEXPORT jint JNICALL
Java_com_toraysoft_widget_gif_GifInfoHandle_getNativeErrorCode(JNIEnv *__unused  env,
        jclass __unused handleClass, jlong gifInfo) {
    GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
    if (info == NULL)
        return 0;
