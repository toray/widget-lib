package com.toraysoft.widget.progresswheel;
...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		contourColor = a.getColor(R.styleable.ProgressWheel_pw_contourColor,
				contourColor);
		contourSize = a.getDimension(R.styleable.ProgressWheel_pw_contourSize,
				contourSize);
