...
import com.toraysoft.widget.imageselector.util.BasePopupWindowForListView;
...
public class ListImageDirPopupWindow extends
	...
	public void initViews() {
		...
		mListDir.setAdapter(new CommonAdapter<ImageFloder>(context, mDatas,
				R.layout.imageselector_item_list_dir) {
			@Override
			public void convert(ViewHolder helper, ImageFloder item) {
				helper.setText(R.id.id_dir_item_name, item.getName());
				helper.setImageByUrl(R.id.id_dir_item_image,
						item.getFirstImagePath());
				helper.setText(R.id.id_dir_item_count, item.getCount() + context.getString(R.string.imageselector_text_page));
			}
		});
	}
